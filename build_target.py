...
# Load the full multi-year dataset instead of just 2024
df = pd.read_csv('f1_all_races.csv', low_memory=False)
...
# driver's lap or bleed from one race into another - and now also never bleed
# from one YEAR into another, since round numbers repeat across seasons.
...
df.to_csv('f1_all_with_target.csv', index=False)
print("\nSaved to f1_all_with_target.csv")